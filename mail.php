...
$mail->CharSet = 'UTF-8';
$mail->From = "noreply@cipressus.uns.edu.ar";         // Desde donde enviamos (Para mostrar)
...
$mail->Body    = $body;
$mail->AltBody = "Necesitas poder leer texto HTML para poder ver el mensaje..."; // Texto sin html
